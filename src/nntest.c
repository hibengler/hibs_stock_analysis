...
int grow_nnl(struct company *pcompanies,int *pnumber_companies,network_t **resultnet)
{
int i;
FILE *pf;
char *line;
...
net = net_load(argv[1]);
grow_nnl(companies,&number_companies,&net);
